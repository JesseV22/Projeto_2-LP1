...
public class FornecedorVIEW extends javax.swing.JInternalFrame {
    ...
    ResultSet rs;
    DefaultTableColumnModel modelo_jtl_consultar_fornecedor;

    public void setPosicao() {
        Dimension d = this.getDesktopPane().getSize();
        this.setLocation(((this.getSize().width - d.width) / 2), (d.height - this.getSize().height) / 2);
    }
    ...
    public FornecedorVIEW() {
        ...
        modelo_jtl_consultar_fornecedor = (DefaultTableColumnModel) jtl_consultar_fornecedor.getModel();
    }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cnpj_for, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(data_cad_for, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(23, 23, 23))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(pesquisa_nome, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
limpaCampos();
    ...
    private void jtl_consultar_fornecedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtl_consultar_fornecedorMouseClicked
        //pega o id do fornecedor selicinado e chama prencheeCampos
    ...
    }//Fechar método liberaBotoes(boolean a,boolean b, boolean c,boolean d,boolean e)
    ...
    private void preencherTabela(String nome_for) {
        try {
            ...
            modelo_jtl_consultar_fornecedor.set(0);
        ...
        }//Fecha método preencherTabela(string nome_for)
    }

    private void preencherTabela(int id_for) {
        try {
